...
function parse(option) {
  ...
  if (option.group){
    ...
    options.group.activationType = option.activationType === Activation.types[0] || option.activationType === Activation.types[2] ? option.activationType : Activation.types[0];
    options.group.activationPfn =  options.group.activationType === Activation.types[0] ? asString(options.group.activationPfn) ?? "" : "";
  }
