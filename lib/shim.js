...
function wrapper(option){
  ...
  return toast.show(settings);
}

export const notify = deprecate(wrapper, "[powertoast]: The default export is deprecated please use the new toast() constructor export instead.");